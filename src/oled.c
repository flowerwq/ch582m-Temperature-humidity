...
void oled_seneor_flag(){
    ...
    OLED_ShowChar(0, 16,h, 16, 1);
    OLED_ShowChar(10, 16,k, 16, 1);
    OLED_ShowChinese(68, 16, 0,16, 1);

    OLED_ShowChar(0, 32,o, 16, 1);
    OLED_ShowChar(10, 32,k, 16, 1);
    OLED_ShowChar(68, 32,m, 16, 1);
    OLED_ShowChar(84, 32,l, 16, 1);
    OLED_ShowChar(94, 32,o, 16, 1);
